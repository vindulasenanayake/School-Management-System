<?php
    ...
    if(isset($_COOKIE["user"]) && isset($_COOKIE["type"]))
    {
        ...
        {
            header('Location: prin_profile.php');
        }
        else 
        {
...
<html>
    ...
    <body class="font" >
                        ...
                        <form action="login.php" method="POST">
                            ...
                            <div class="col-12" style="padding-top:0.8rem;"> 
                                <center>
                                        ...
                                        <button name="btn_submit" type="submit" class="btn btn-green btn-large btn-wide">Search</button>
                                    </div>
        ...
        $result = mysqli_query($con, "SELECT * FROM user_login WHERE username='$user');
