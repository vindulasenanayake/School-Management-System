                    ...
                    <div class='card-container'>                           
                        <div class='card-job card-top'>
                            ...
                            <br>
                                ...
                                <div class='row'>
                                    <div class='center'><strong>Upload A/L Results</strong></div>                                  
                                </div><hr>

                                    <div class='center'>
                                        <form action="admin.php" method="POST">
                                            <a href="al_results.php"><img src="images/up.png"></a>
                    ...
                    <div class='card-container'>                           
                        <div class='card-job card-top'>
                            ...
                            <br>
                                ...
                                <div class='row'>
                                    <div class='center'><strong>Upload O/L Results</strong></div>                                  
                                </div><hr>
                    ...
                    <div class='card-container'>                           
                        <div class='card-job card-top'>
                            ...
                            <br>
                                ...
                                <div class='row'>
                                    <div class='center'><strong>Upload TermTest Marks</strong></div>                                  
                                </div><hr>
